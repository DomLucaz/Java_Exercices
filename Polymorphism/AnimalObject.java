...
public class AnimalObject {
	...
	do {
			...
			while (op >=1 || op<= 2) {
				if (op == 1) {
					String sound = scan.next(); au.sound(sound); 
					break;
				} if (op == 2) {
					String run = scan.next(); au.run(run); 
					break;
					}
			}
			break;
			...
			while (op >=1 || op<= 2) {
				if (op == 1) {
					String sound = scan.next(); pocoto.sound(sound); 
					break;
				} if (op == 2) {
					String run = scan.next(); pocoto.run(run); 
					break;
					}
			}
			break;
			...
			while (op >=1 || op<= 2) {
				if (op == 1) {
					String sound = scan.next(); lerdo.sound(sound); 
					break;
				} if (op == 2) {
					lerdo.climb();
					break;
